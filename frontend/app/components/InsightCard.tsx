  ...
  return (
    ...
    <div className ="flex flex-wrap gap-6">
        {titleData[person].map((item,index) => (
            <div key={index} className="flex flex-col p-5 items-start gap-5 justify-center shadow-lg 2xl:w-[820px] 2xl:h-[360px] md:w-[410px] md:h-[180px] bg-white rounded-2xl hover:shadow-2xl">
